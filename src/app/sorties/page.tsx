      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
        ...
        {(startDateFilter || endDateFilter) && (
          <button
            ...
            className="lg:col-span-2 py-2 bg-slate-850 hover:bg-slate-800 text-rose-400 hover:text-rose-350 border border-slate-800 rounded-xl font-bold text-xs cursor-pointer transition-colors text-center"
          >
            Reset
          </button>
        )}
